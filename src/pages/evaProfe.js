  ...
  <div className="col-md-6 mt-4">
        <div className="card">
            <div className="card-body">
                <h3>Formulario de evaluacion de profesor</h3>
                <form className="mt-4">
                    ...
                    <div className="row my-3">
                        ...
                        <div className="col my-1">
                                <div>
                                    <input type="radio" id='profesor1' />
                                     <label for="profesor">123</label>
                                </div>
                                <div>
                                    <input type="radio" id='profesor2' />
                                    <label for="profesor">zzz</label>
                                </div>
                                <div>
                                    <input type="radio" id='profesor3' />
                                    <label for="profesor">asdasd</label>
                                </div>
                                <div>
                                    <input type="radio" id='profesor4' />
